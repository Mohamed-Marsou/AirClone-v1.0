...
const Users = () => {
    ...
    return (
        <section className="userSection max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
            <div className="text-center pb-12">
                <h1 className="font-bold text-3xl md:text-4xl lg:text-5xl font-heading text-white">
                    Check our awesome Hosters
                </h1>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="  userCard w-full bg-gray-900 rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                    <div className="mb-8">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-base text-gray-400 font-normal">Dany@gmail.com</p>
                    </div>
                    <div className="mt-4 actionsBtns">
                        <a href="#">
                            Edit
                        </a>
                        <form action="">
                ...
                <div className="userCard w-full bg-gray-900 rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-base text-gray-400 font-normal">Lucy@gmail.com</p>
                    </div>
                    <div className="mt-4 actionsBtns">
                        <a href="#">
                            Edit
                ...
                <div className="userCard w-full bg-gray-900 rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-base text-gray-400 font-normal">Jade@gmail.com</p>
                    </div>
                    <div className="mt-4 actionsBtns">
                        <a href="#">
                            Edit
            ...
            <nav classNameName="Page" aria-label="Page navigation">
